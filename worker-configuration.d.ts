/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d9b3ef0c85a31f5471762502e00a624c)
// Runtime types generated with workerd@1.20250612.0 2025-06-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		__TEST__: string;
		__MOCK_DATETIME__: string;
		EVENT_DATABASE: DurableObjectNamespace<import("./src/index").EventDatabase>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "__TEST__" | "__MOCK_DATETIME__">> {}
}
declare module "*.sql" {
	const value: string;
